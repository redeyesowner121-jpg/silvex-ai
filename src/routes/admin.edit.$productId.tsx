...
function EditProductPage() {
  ...
  if (!product) return <div className="rounded-2xl bg-card p-8 text-center"><h1 className="text-lg font-black">Product not found</h1><Link to="/admin" search={{ tab: "Products" }} className="mt-4 inline-block text-sm font-bold text-primary">Back to products</Link></div>;
